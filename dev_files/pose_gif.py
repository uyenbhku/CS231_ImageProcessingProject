...
if __name__ == '__main__':
    ...
    angel_wings_animation = cv2.VideoCapture('./assets/gifs/output_angel_wings.mp4')
    angel_wings_frame_count = 0

    # Load effect heart_light
    love_light_animation = cv2.VideoCapture('./assets/background/resized_heart_light.mp4')
    love_light_frame_count = 0

    # Sound
    mixer.init()
    mixer.music.load('./audio/magic_song.mp3')
    # To play sound
    count_sound = 1
